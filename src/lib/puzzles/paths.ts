...
export const PATHS: PathMeta[] = [
  ...
  // ── GMAT Practice Tests 1–10 ────────────────────────────
  {
    ...
    description: "Arithmetic & Critical Reasoning. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Algebra & Reading Comprehension. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Geometry & Analysis. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Word Problems & Verbal. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Number Theory & Critical Reasoning. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Statistics & Reading Comprehension. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Combinatorics & Critical Reasoning. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Coordinate Geometry & Verbal. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Functions & Critical Reasoning. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
  },
  {
    ...
    description: "Mixed Review & Data Insights Focus. 21Q Quant · 23Q Verbal · 20Q Data Insights.",
    icon: "📝",
    questionCount: 64,
    category: "gmat",
    difficulty: "Mixed",
